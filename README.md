...
## Eval
A pre-requisite for training a strong LM is having a robust evaluation suite that can guide model development while tracking its utility in real-world applications [(Gao, 2024)](https://arxiv.org/pdf/2410.02660).
